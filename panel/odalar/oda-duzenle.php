...
<div class="page-content">
  ...
  <div class="content">
    <ul class="breadcrumb">
      ...
      <li><a href="index.php" class="active">Oda Düzenle</a> </li>
    </ul>
    <div class="row">
      <div class="col-md-9">
       <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>  <span class="semi-bold">Oda Düzenle</span></h3>
      </div>
 ...
 <div class="grid simple">
  <div class="grid-title no-border">
    <h4>Oda <span class="semi-bold">Düzenle</span></h4>
  ...
  <div class="grid-body no-border">
      ...
      <div class="row">
        ...
        <div class="form-group">
         ...
         <div class="col-md-9 col-sm-9">
          <div class="controls">
            <input type="text" class="form-control" name="oda_adi" value="<?php echo $odacek['oda_adi']; ?>">
          </div>
        </div>
    ...
    <div class="form-group">
       ...
       <div class="col-md-9 col-sm-9">
        <div class="controls">
          <input type="text" class="form-control" name="oda_fiyat" value="<?php echo $odacek['oda_fiyat']; ?>">
        </div>
      </div>
...
<input type="hidden" name="id" value="<?php echo $odacek['id']; ?>">
 
 <div class="col-sm-12 ozellikler">

      <hr>
      <center> <h2>Oda Özellikleri  <button onclick="ozellikEkle()" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Ekle</button></h2> </center>
       
    <?php foreach (explode('&&&', $odacek['oda_ozellik']) as $key => $value) {  if(!$value)continue; ?>
<div class="form-group"> <div class="col-sm-8"> <div class="controls"> <input type="text" class="form-control" name="ozellik[]" value="<?= $value; ?>" placeholder="Oda Özelliği"> </div> </div> </div>
<?php } ?>
 </div>
</div>
<br>
<input type="hidden" name="odaduzenle" value="a">
<center>
